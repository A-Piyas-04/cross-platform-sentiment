...
| `compression_vs_transfer.png` | 19 — Correlation | Relationship between linguistic compression (e.g., TTR diff) and F1 drop per emotion |
| `calibration_curves.png` | 20 — Calibration | Reliability diagrams showing predicted probability vs observed frequency per class |
| `clinical_risk_chart.png` | 22 — Risk framing | Visual summary of F1 drop and missed detection rates per emotion class |
...
| Environment | Path |
|-------------|------|
| Colab | `/content/emotion_project/visualisations/` |
| Kaggle | `/kaggle/working/emotion_project/visualisations/` |
